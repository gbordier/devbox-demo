...
while ((Get-AzImageBuilderTemplate -ResourceGroupName $imageResourceGroup ).LastRunStatusRunState -ieq "Running") { write-host "$(get-date) : running" ; sleep 300 }
...
## if it does not work, 
Get-AzImageBuilderTemplate -ResourceGroupName $imageResourceGroup -name 
